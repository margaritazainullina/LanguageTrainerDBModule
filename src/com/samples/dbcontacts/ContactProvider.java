...
public class ContactProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.samples.dbcontacts.contactprovider/contact");
	...
	public Cursor query(Uri url, String[] projection, String selection,
		...
		Cursor c = db.query(ContactDbHelper.TABLE_NAME, projection, selection,
	...
	public Uri insert(Uri url, ContentValues inValues) {
		...
		long rowId = db.insert(ContactDbHelper.TABLE_NAME,
				ContactDbHelper.NAME, values);
		if (rowId > 0) {
