...
import com.samples.dbcontacts.R;
...
public class MainActivity extends ListActivity {
	...
	private static final String[] mContent = new String[] { DictionaryDbHelper._ID,
			DictionaryDbHelper.KANJI, DictionaryDbHelper.LEVEL,
			DictionaryDbHelper.TRANSCRIPTION, DictionaryDbHelper.ROMAJI,
			DictionaryDbHelper.TRANSLATIONS, DictionaryDbHelper.EXAMPLES,
			DictionaryDbHelper.PERCENTAGE, DictionaryDbHelper.SHOWNTIMES,
			DictionaryDbHelper.LASTVIEW };

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		SQLiteDatabase db = FlightProvider.getDb();
		...
		mAdapter = new SimpleCursorAdapter(this, R.layout.main, mCursor,
				new String[] { DictionaryDbHelper.KANJI,DictionaryDbHelper.LEVEL,
						DictionaryDbHelper.TRANSCRIPTION, DictionaryDbHelper.ROMAJI,
						DictionaryDbHelper.TRANSLATIONS, DictionaryDbHelper.EXAMPLES,
						DictionaryDbHelper.PERCENTAGE, DictionaryDbHelper.SHOWNTIMES,
